// Test script to debug the debug-recommendations edge function
...
async function testDebugFunction() {
  console.log('=== Testing Debug Recommendations Edge Function ===');
  
  try {
    const response = await fetch(`${SUPABASE_URL}/functions/v1/debug-recommendations`, {
      method: 'POST',
      headers: {
